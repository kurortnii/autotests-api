...
class TestExercises:
    def test_create_exercise(self, exercise_client: ExerciseClient, function_course: CourseFixture):
    ...
    def test_get_exercise(self, exercise_client: ExerciseClient, function_exercise: ExerciseFixture):
